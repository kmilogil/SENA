...
<%
    ...
    informacionUsuario = (UsuarioDto) miSesion.getAttribute("infUsuario");
            ...
            <div class="row">
                ...
                <div class="col-md-10">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active"><a href="informacionusuario.jsp">Información</a></li>                    
                    </ol>
                    <!-- Fin de miga de pan -->
                            ...
                            <div class="col-md-12">
                                <div class="container-fluid">
                                    <form class="form-horizontal">
                                        <legend class="text-center">Datos Personales del usuario</legend>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" name="auDocumento" class="form-control" 
                                                           ...
                                                           value="<%=informacionUsuario.getIdUsuario()%>">                                                           
                                                </div>
                                            </div>
                                            <div class="form-group" id="inpDireccion">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" name="Direccion" readonly
                                                           id="ruDireccion" tabindex="6" value="<%=informacionUsuario.getDireccion()%>" maxlength="45">
                                            ...
                                            <div class="form-group" id="inpDepartamento">
                                                ...
                                                <div class="col-sm-8">
                                                    <select name="ruDepartamento" readonly id="ruDepartamento" class="form-control" tabindex="9" >
                                                        <option value="0"><%=informacionUsuario.getCiDto().getDepartamento().getDepartamento()%></option>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" name="auNombres" class="form-control" readonly
                                                           ...
                                                           value="<%=informacionUsuario.getNombres() + " " + informacionUsuario.getApellidos()%>">
                                                </div>
                                            </div>

                                            <div class="form-group">
                                                <label for="auDireccion" class="col-sm-4 control-label">Correo</label>
                                                <div class="col-sm-8">
                                                    <input type="text" name="auDireccion" class="form-control" readonly
                                                           id="auDireccion" placeholder="Dirección"
                                                           value="<%=informacionUsuario.getCorreo()%>">                                                  
                                                </div>
                                            </div>
                                            <div class="form-group" id="inpCiudad">
                                                ...
                                                <div class="col-sm-8">
                                                    <select name="ruCiudad" id="ruCiudad" class="form-control" tabindex="10" readonly>
                                                        <option value=""><%=informacionUsuario.getCiDto().getNombre()%></option>
