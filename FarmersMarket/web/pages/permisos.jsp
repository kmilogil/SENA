        ...
        <div class="container">
            ...
            <div class="row">
                    ...
                    <nav class="navbar navbar-default">
                        <div class="container-fluid">  
                            <form action="../ControladorCargarInicial" method="post" enctype="multipart/form-data" class="navbar-brand form-inline">
                                ...
                                <button type="submit" class="btn btn-default" title="Subir archivo" data-toggle="alert" data-target="cargainicial"><i class="fa fa-arrow-circle-up"></i></button>
                            </form>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="page-header">
                                <h4 class="text-center lead">Administración de los usuarios</h4>
                            </div>
                            <%
                            ...
                            %>
                            <table class="table table-hover" id="flusuarios">
                                <thead>
                                    <tr>
                                        <th>Rol</th>
                                        <th>Nombre</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="" data-toggle="modal" data-target="#modalCambiarRol" onclick="getUsuarioAdmin(<%=usuario.getIdUsuario()%>)"><i class="fa fa-tasks"></i> Cambiar</a></td>                                        
                                        <td><a href="" onclick="getSuspencion(<%=usuario.getIdUsuario()%>,<%=usuario.getEstado()%>)" data-toggle="modal" data-target="#modalConfirmarSuspencion" ><i class="fa fa-exclamation-triangle"></i> <%=activar%></a></td>
                ...
                <div class="container-fluid">
                    ...
                    <div>
                        <div class="modal fade bs-example-modal-sm" id="modalCambiarRol" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
                            <div class="modal-dialog modal-sm">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h4 class="modal-title text-center" id="myModalLabel">¿Está seguro de cambiar el rol del usuario?</h4>
                                    </div>
                                    <form action="../ControladorAdministrador" method="post">
                                        <div id="didUsuarioCambio"><input type="hidden" name="idUsuarioCambio" id="idUsuarioCambio" value="">
                                            <input type="hidden" name="idRolCambio" id="idRolCambio" value=""></div>                                            
                                        <div class="modal-footer">
                                            <center>
                                                <button type="submit" class="btn btn-success" name="cambiarRol" id="cambiarRol" >Sí</button>
                    ...
                    <div>
                        <div class="modal fade bs-example-modal-sm" id="modalConfirmarSuspencion" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
                            <div class="modal-dialog modal-sm">
                                <div class="modal-content">
                                    <div class="modal-header">
                                    ...
                                    <form action="../ControladorAdministrador" method="post">
                                        <div id="didUsuario"><input type="hidden" name="idUsuario" id="idUsuario" value="">
                                            <input type="hidden" name="estado" id="estado" value=""></div>                                            
                                        <div class="modal-footer">
                                            <center>
                                                <button type="submit" class="btn btn-success" name="suspender" id="suspender" >Sí</button>
                                                <button type="button" class="btn btn-danger" data-dismiss="modal">No</button>                                                
                                            </center>  
